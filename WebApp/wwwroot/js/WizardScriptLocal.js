...
function SubmitTeam() {
    ...
    $.ajax({
        ...
        if (!success) {
            ...
            var teamAddMessage = generateFormMessage("Success", "Arbetslaget blev tillagt.");
            $('#messageBoxTeamCrud').html(teamAddMessage);
        }
    }, function () {
...
function CreateInputTeam() {
    ...
    $('#teamCrudForm').append($('<div/>', { class: 'messageBox', id: 'messageBoxTeamCrud' }));
...
function EditPersonById(id) {
    ...
    $.ajax({
        ...
        if (success) {
            ...
            var personnelAddMessage = generateFormMessage("error", "Något fält är fel ifyllt.");
            $('#messageBoxPersonnelCrud').html(personnelAddMessage);
        }
    }, function () {
        var personnelAddMessage = generateFormMessage("error", "Något gick fel.");
        $('#messageBoxPersonnelCrud').html(personnelAddMessage);
...
function SubmitStudentGroup() {
    ...
    $.ajax({
        ...
        if (success) {
            ...
            var studentGroupAddMessage = generateFormMessage("error", "Klassen existerar redan.");
            $('#messageBoxStudentGroupCrud').html(studentGroupAddMessage);
        }
    }, function () {
...
function UpdateStudentGroup(id) {
    ...
    $.ajax({
        ...
        if (success) {
            ...
            var studentGroupAddMessage = generateFormMessage("error", "Något fält är fel ifyllt.");
            $('#messageBoxStudentGroupCrud').html(studentGroupAddMessage);
        }
    }, function () {
        var studentGroupAddMessage = generateFormMessage("error", "Något gick fel.");
...
function CreateStudentGroupInput() {
    ...
    $target.append('<div/>', { class: 'messageBox', id: 'messageBoxStudentGroupCrud' });
...
function SubmitAuxiliaryAssignment() {
    ...
    $.ajax({
        ...
        if (success) {
            ...
            var auxAssignmentAddMessage = generateFormMessage("error", "Uppdraget finns redan.");
            $('#messageBoxAuxiliaryAssignmentCrud').html(auxAssignmentAddMessage);
        }
    }, function () {
...
function CreateAuxiliaryAssignmentInput() {
    ...
    $target.append('<div/>', { class: 'messageBox', id: 'messageBoxAuxiliaryAssignmentCrud' });
    $target.append($nameInput);
